...
anchors_list = torch.tensor(anchors_list).view(-1,3,2).float()[[2,1,0],...]
anchors_list[0] = anchors_list[0]/32
anchors_list[1] = anchors_list[1]/16
anchors_list[2] = anchors_list[2]/8
...
def non_max_suppression(prediction, conf_thres=0.1, iou_thres=0.6, multi_label=True, classes=None, agnostic=False):
    """
    :prediction Tensor[1,10647,6] <--  list[Tensor[bs,3,13,13,5+n_cls],Tensor[bs,3,26,26,5+n_cls],Tensor[bs,3,52,52,5+n_cls]] -->
    Tensor[bs,507,5+n_cls],Tensor[bs,2028,5+n_cls],Tensor[bs,8114,5+n_cls] --> cat Tensor[bs,10647,5+n_cls]
